...
/*
t_no* _buscar_abb(t_no* raiz, void* chave, t_comparar_abb comparar) //Busca recursiva
{
    if(raiz == NULL)
    {
        return NULL;
...
void* _buscar_abb(t_no* raiz, void* chave, t_comparar_abb comparar)//busca interativa
{
    void* retorno = NULL;
    int continua = 1;
...
{
    _buscar_abb(abb -> raiz, chave, abb -> comparar);
}
...
t_no* _remover_abb(t_no* raiz, void* chave, t_comparar_abb comparar)
{
    ...
    else
    {
        ...
        else
        {
            ...
            else if ((raiz -> sae == NULL) && (raiz -> sad != NULL))//Descendente na sae
            {
